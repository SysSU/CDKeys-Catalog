...
echo "<h2> $viewalltitle </h2>";
echo "<p> $viewalltext </p>";
...
echo "<li> <a href=\"index.php?pg=keys&view=single&key=".$row{'id'}."\">".$row{'program'}."</a></li>";
// Add to counter
$count++ ;			
} 
...
echo "&nbsp;<a href=\"index.php?pg=keys&s=$prevs\">&lt;&lt; Prev 10</a>&nbsp&nbsp;";
}
...
echo "&nbsp;<a href=\"index.php?pg=keys&s=$next\">Next 10 &gt;&gt;</a>";
}
